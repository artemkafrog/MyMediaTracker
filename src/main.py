...
class MediaTrackerApp:
    """Main application class for MediaTracker."""
    ...
    def _add_item(self) -> None:
        """Add a new item through interactive prompt."""
        print("\n--- Add new video ---")
    ...
    def _show_collection(self) -> None:
        """Display the collection with optional filtering."""
        print("\n--- All collection ---")
